...
export namespace OpenAPI {
  ...
  export const Discriminator = Type.Object({
  ...
  // OAuth Flow Object
  export const OAuthFlow = Type.Object({
  ...
  export const ExternalDocumentation = Type.Object({
    description: Type.Optional(Type.String()),
    url: Type.String(),
  });

  // OAuth Flows Object
  export const OAuthFlows = Type.Object({
  ...
  export const SecurityScheme = Type.Object({
    type: Type.Union([
      Type.Literal("apiKey"),
      Type.Literal("http"),
      Type.Literal("oauth2"),
  ...
  // Path Item Object
  export const PathItem = Type.Object({
    summary: Type.Optional(Type.String()),
    description: Type.Optional(Type.String()),
  ...
  export const Components = Type.Object({
    ...
    parameters: Type.Optional(Type.Record(Type.String(), ParameterOrReference)),
    examples: Type.Optional(Type.Record(Type.String(), ExampleOrReference)),
